                ...
                if (int.TryParse(Console.ReadLine(), out choice))
                {
                    switch (choice)
                    {
                        case 1:
                            ...
                            Doctor newDoctor = new Doctor(doctorId, doctorName, specialization);
                            try
                            {
                ...
                if (int.TryParse(Console.ReadLine(), out choice))
                {
                    switch (choice)
                    {
                        case 1:
                            ...
                            Patient newPatient = new Patient(patientId, patientName, age);
                            try
                            {
                ...
                if (int.TryParse(Console.ReadLine(), out choice))
                {
                    switch (choice)
                    {
                        case 1:
                            ...
                            Appointment newAppointment = new Appointment(appointmentId, appointmentDate, doctorId, patientId);
                            try
                            {
